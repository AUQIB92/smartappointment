        ...
        <div className="prose max-w-none">
          ...
          <div className="mt-10">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-medium text-gray-900">Is it safe to pay online?</h3>
                <p className="mt-2 text-gray-600">
                  Yes, all online payments are processed through Razorpay, a trusted payment gateway that ensures your payment information is secure and encrypted. We do not store your card details on our servers.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-medium text-gray-900">What happens if my payment fails?</h3>
                <p className="mt-2 text-gray-600">
                  If your payment fails for any reason, no amount will be deducted from your account, and no appointment will be created. You can try booking again with a different payment method or contact our support team for assistance.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-medium text-gray-900">When is my appointment confirmed?</h3>
                <p className="mt-2 text-gray-600">
                  Your appointment is only created and confirmed after successful payment verification. Once your payment is verified, you will receive a confirmation email and SMS with your appointment details.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-medium text-gray-900">Will I get a receipt for my payment?</h3>
                <p className="mt-2 text-gray-600">
                  Yes, after successful payment, you will receive a confirmation via email and SMS that includes your payment details. You can also view your payment details in your dashboard under the Appointments section.
                </p>
              </div>
